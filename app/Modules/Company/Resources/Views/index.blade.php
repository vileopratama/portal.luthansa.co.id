...
@section('content')
    ...
    <div class="row panel-header">
        <div class="col-md-6">
			{!! Form::open(['url' => '/company','role' => 'form','id'=>'company_search_form','method'=>'GET','class' => 'form-inline']) !!}
		...
		<div class="col-md-6">
            ...
            <div class="pull-right">
                <div class="btn-group" role="group">
                    ...
                    <a href="{!! url('company/create') !!}" class="btn btn-primary btn-md color-white"><i class="fa fa-plus"></i> {!! Lang::get("global.create") !!}</a>
					@endif
				</div>
            </div>
        </div>
    </div>
	@if($companies->appends(Request::except('page'))->render())
	<div class="row panel-header">
		<div class="col-md-12">
                        ...
                        <td class="text-center">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{!! url('/company/view/'.Crypt::encrypt($company->id)) !!}"> {!! Lang::get('global.view') !!}</a></li>
                                    @if(App::access('u','company'))
									<li><a href="{!! url('/company/edit/'.Crypt::encrypt($company->id)) !!}"> {!! Lang::get('global.edit') !!}</a></li>
                                    @endif
									@if(App::access('d','company'))
									<li><a href="#" id="{!! Crypt::encrypt($company->id) !!}" class="delete"> {!! Lang::get('global.delete') !!}</a></li>
									@endif
								</ul>
                            </div>
                        </td>
