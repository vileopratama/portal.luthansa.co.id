                ...
                <table class="table table-hover">
					<thead>
						<tr>
							...
							<th class="col-md-1 text-center">{!! Lang::get('global.total') !!}</th>
                    ...
                    <tr class="row-{!! $sales_order->id !!}">
                        ...
                        <td class="text-right">{!! number_format($sales_order->total,2) !!}</td>
                        <td class="text-center">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{!! url('/sales-order/view/'.Crypt::encrypt($sales_order->id)) !!}"> {!! Lang::get('global.view') !!}</a></li>
                                    @if(App::access('u','sales-order'))
									<li><a href="{!! url('/sales-order/edit/'.Crypt::encrypt($sales_order->id)) !!}"> {!! Lang::get('global.edit') !!}</a></li>
                                    @endif
