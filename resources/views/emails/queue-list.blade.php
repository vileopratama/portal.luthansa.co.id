	...
	<tr valign="top">
		<td width="100%">
			...
			<div style="margin-top:30px;color:#333!important;font-family:arial,helvetica,sans-serif;font-size:12px">
				<span style="color:#333333!important;font-weight:bold;font-family:arial,helvetica,sans-serif">Kpd Yth Management, <br/> Luthansa Groups Tour & Transport </span><br><br>
				<p style="font-size:8px;color:#c88039;font-weight:bold;text-decoration:none">Berikut adalah list yang melakukan Order di Website Luthansa :</p>
				...
				<table align="center" border="0" cellpadding="0" cellspacing="0" style="clear:both;color:#666666!important;font-family:arial,helvetica,sans-serif;font-size:11px" width="100%">
					<tbody>
					<tr>
						<td style="border:1px solid #ccc;border-right:none;border-left:none;padding:5px 10px 5px 10px!important;color:#333333!important" width="50" align="left">No.Order</td>
						...
						<td style="border:1px solid #ccc;border-right:none;border-left:none;padding:5px 10px 5px 10px!important;color:#333333!important" width="170" align="left">Tgl Booking</td>
					</tr>
					
					@foreach($rows as $key => $row)
						<tr>
							<td style="padding:10px" align="left" >{!! '#'.$row->id !!}</td>
